    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <IonItem>
        <Controller
          ...
          name="username"
          rules={{ required: true }}
          render={({ field: { value, onBlur, onChange } }) => <IonInput type="text" onIonBlur={onBlur} value={value} onInput={onChange} onIonChange={onChange} placeholder="Username" />}
        />
      ...
      <IonItem>
        <Controller
          ...
          name="password"
          rules={{ required: true }}
          render={({ field: { value, onBlur, onChange } }) => <IonInput type="password" onIonBlur={onBlur} value={value} onInput={onChange} onIonChange={onChange} placeholder="Password" />}
        />
