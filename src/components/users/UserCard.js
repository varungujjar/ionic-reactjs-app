...
export const UserCardCarousel = ({ userFullName, userId, userName, userProfileImage }) => {
  const image_src = userProfileImage.rawvalue ? config.baseUrl + JSON.parse(userProfileImage.rawvalue)["imagefile"] : "./assets/images/article-no-image.png";
    ...
    <Card>
      <div className="d-flex align-items-center p-3">
        <div className="flex-shrink-0 placeholder-img user-card-thumb">
          <img src={"./assets/images/article-no-image.png"} />
        </div>
        <div className="flex-grow-1 ms-3">
          <div className="card-body">
